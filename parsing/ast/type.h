...
public:
    ...
    Type(TypeBase* typeBase, bool isMutable, Position location) : typeBase(typeBase), mutableFlag(isMutable), location(location) {}
    ...
    Type withLocation(Position location) const { return Type(typeBase, mutableFlag, location); }
    ...
    static Type getInt16(bool isMutable = false, Position location = Position());
    static Type getInt32(bool isMutable = false, Position location = Position());
    static Type getInt64(bool isMutable = false, Position location = Position());
    static Type getUInt(bool isMutable = false, Position location = Position());
    static Type getUInt8(bool isMutable = false, Position location = Position());
    static Type getUInt16(bool isMutable = false, Position location = Position());
    static Type getUInt32(bool isMutable = false, Position location = Position());
    static Type getUInt64(bool isMutable = false, Position location = Position());
    static Type getUIntPtr(bool isMutable = false, Position location = Position()) { return getUInt64(isMutable, location); }
    static Type getFloat(bool isMutable = false, Position location = Position());
    static Type getFloat32(bool isMutable = false, Position location = Position());
    static Type getFloat64(bool isMutable = false, Position location = Position());
    static Type getFloat80(bool isMutable = false, Position location = Position());
    static Type getString(bool isMutable = false, Position location = Position());
    ...
    static Type getUndefined(bool isMutable = false, Position location = Position());
...
std::string getRefinedTypeName(llvm::StringRef typeName, llvm::ArrayRef<Type> genericArgs);

class BasicType : public TypeBase {
public:
    llvm::ArrayRef<Type> getGenericArgs() const { return genericArgs; }
    llvm::StringRef getName() const { return name; }
    std::string getRefinedName() const { return getRefinedTypeName(name, genericArgs); }
    TypeDecl* getDecl() const { return decl; }
    void setDecl(TypeDecl* decl) { this->decl = decl; }
    static Type get(llvm::StringRef name, llvm::ArrayRef<Type> genericArgs, bool isMutable = false, Position location = Position());
...
public:
    ...
    static Type get(Type type, int64_t size, bool isMutable = false, Position location = Position());
...
public:
    ...
    static Type get(std::vector<TupleElement>&& elements, bool isMutable = false, Position location = Position());
...
public:
    ...
    static Type get(Type returnType, std::vector<Type>&& paramTypes, bool isMutable = false, Position location = Position());
...
public:
    ...
    static Type get(Type pointeeType, bool isMutable = false, Position location = Position());
...
public:
    ...
    static Type get(Type wrappedType, bool isMutable = false, Position location = Position());
